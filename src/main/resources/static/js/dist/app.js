function DashboardApp() {
  ...
  return React.createElement("div", {
  ...
  }, activeTab === 'overview' && React.createElement(window.OverviewPage, {
  ...
  }), activeTab === 'subscribers' && React.createElement(window.SubscribersPage, {
    subscribers: subscribers,
    onOpenAddModal: () => {
      setEditSubscriber(null);
  ...
  }), activeTab === 'departments' && React.createElement(window.DepartmentsPage, {
    departments: departments,
    subscribers: subscribers,
    onOpenAddModal: () => {
      setEditDept(null);
  ...
  }))), React.createElement(window.SubscriberModal, {
    ...
    departments: departments,
    availableSites: availableSites
  }), React.createElement(window.DepartmentModal, {
    ...
    editDept: editDept,
    availableSites: availableSites
  }), React.createElement(window.ImportModal, {
    ...
    onClose: () => setConfirmModalConfig(prev => ({
      ...prev,
      isOpen: false
    })),
...
ReactDOM.render(React.createElement(DashboardApp, null), document.getElementById('root'));
